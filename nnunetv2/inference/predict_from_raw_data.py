...
class nnUNetPredictor(object):
    ...
    def _internal_get_sliding_window_slicers(self, image_size: Tuple[int, ...]):
        ...
        x_steps = compute_steps_for_sliding_window((image_size[0],), (self.configuration_manager.patch_size[0],), self.tile_step_size)[0]

        # For y and z axis, get the center three patches with boundary checks
        for dim in [1, 2]:  # y and z axis
            ...
            if dim == 1:
                ...
                z_steps = [first_patch_start, center_start, third_patch_start]
        ...
        if self.verbose: 
            print(f'n_steps {len(x_steps) * len(y_steps) * len(z_steps)}, image size is {image_size}, tile_size {self.configuration_manager.patch_size}, '
