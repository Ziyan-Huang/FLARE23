...
def convert_predicted_logits_to_segmentation_with_correct_shape(predicted_logits: Union[torch.Tensor, np.ndarray],
    ...
    # print(type(predicted_logits))
    # print(type(properties_dict['shape_after_cropping_and_before_resampling']))
    # print(properties_dict['shape_after_cropping_and_before_resampling'])
    # print(configuration_manager.resampling_fn_probabilities)
    ...
    # predicted_logits = torch.nn.functional.interpolate(predicted_logits, new_shape, mode='nearest')
    # predicted_logits = predicted_logits.squeeze(0)

    segmentation = segmentation.float()
    segmentation = segmentation.unsqueeze(0)
    segmentation = segmentation.unsqueeze(0)
    segmentation = torch.nn.functional.interpolate(segmentation, properties_dict['shape_after_cropping_and_before_resampling'], mode='nearest')
    ...
    # end_time =  time.time()
    # print(f"\t nonlin 的执行时间为: {end_time - start_time} 秒")
